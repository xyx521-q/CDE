...
python main.py --config=facmac_smac --env-config=microgrid batch_size_run=1 use_cuda=False t_max=5000
```
...
```bash
python main.py --config=facmac_smac --env-config=microgrid use_cuda=False
```
